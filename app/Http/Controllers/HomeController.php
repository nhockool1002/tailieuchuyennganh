...
class HomeController extends Controller
{
    public function getHome()
    {
    	...
    	return view('frontend.home.index', compact('menus', 'recent3post', 'stickytop2post' , 'recent3post1', 'recent3post2', 'random7post', 'random2book', 'digital3post', 'foreign4post', 'graphic6post', 'cats', 'homepage_rightside_300x250_first', 'homepage_rightside_300x250_second', 'popup'));
    }
