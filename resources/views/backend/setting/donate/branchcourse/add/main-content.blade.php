            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Thêm nguồn khóa học VIP</h4>
                                <small>Thêm mới nguồn khóa học mới VIP</small>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="donateboxsetting">
                                        ...
                                        <form method="POST" action="">
                                            @csrf
                                            <label>Nhập tên nguồn khóa học</label>
                                            <input name="branchcourse" type="text" class="form-control border-input" required />
